...
import companies from '@/Dynamic-Data/companies_date/companiesData';
import RefineSearchComponent from '@/components/siderbars/RefineSearchComponent';
const CompaniesLogos = ({ companies }) => {
    ...
    return (
        <section className="companies_logos">
            <div className="container companies_logos_container">
                    ...
                    <div className="col-lg-8">
                        <div className="row g-3">
                            {displayedCompanies.map((company, index) => (
                                <div key={index} className="col-lg-4 col-6 d-flex align-items-stretch">
...
//                     <div className="col-lg-8">
//                         <div className="row g-3">
//                             <div className="col-lg-4 col-6  d-flex align-items-stretch">
//                                 <div className="card companies_logo_cards">
//                                     <div className="card-body">
//                                         <div className="logo_div">
//                                             <img src="assets/img/company/logo_1.png" alt="" />
//                                         </div>
//                                         <h5>Lasermed group of industrys</h5>
//                                     </div>
//                                     <div className="card-footer bg-transparent border-0 pt-0">
//                                         <div className="pb-2">
//                                             <a href="#">
...
//                                         <div className="logo_div">
//                                             <img
//                                                 src="assets/img/company/logo_3.png"
//                                                 alt=""
//                                                 className="roll_logo"
//                                             />
//                                         </div>
...
//                                     <div className="card-body">
//                                         <div className="logo_div">
//                                             <img src="assets/img/company/logo_2.png" alt="" />
//                                         </div>
//                                         <h5>Lasermed group of industrys</h5>
//                                     </div>
//                                     <div className="card-footer bg-transparent border-0 pt-0">
